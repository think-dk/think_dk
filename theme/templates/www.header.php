...
<? } else { ?>
	<link type="text/css" rel="stylesheet" media="all" href="/css/seg_<?= $this->segment() ?>.css?rev=20190514-204520" />
	<script type="text/javascript" src="/js/seg_<?= $this->segment() ?>.js?rev=20190514-204520"></script>
<? } ?>
