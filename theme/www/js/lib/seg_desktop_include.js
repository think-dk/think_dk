...
document.write('<script type="text/javascript" src="/js/lib/u-basics.js"></script>'); // different from skin
document.write('<script type="text/javascript" src="/js/lib/desktop/i-front.js"></script>'); // different from skin
document.write('<script type="text/javascript" src="/js/lib/desktop/i-scene.js"></script>'); // u.showscene not in skin, else the same
document.write('<script type="text/javascript" src="/js/lib/desktop/i-login.js"></script>'); // u.showscene is not in skin, else the same
...
document.write('<script type="text/javascript" src="/js/lib/desktop/i-cart.js"></script>'); // not in parentNode skin
document.write('<script type="text/javascript" src="/js/lib/desktop/i-wishes.js"></script>'); // outdated, but u.showScene at end of file
document.write('<script type="text/javascript" src="/js/lib/desktop/i-memberships.js"></script>'); // not in parentNode skin
document.write('<script type="text/javascript" src="/js/lib/desktop/i-payment.js"></script>'); // not in parentNode skin
