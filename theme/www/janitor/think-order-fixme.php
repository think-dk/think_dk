...
// POST ADJUSTMENT FOR MECHTHILD
if($query->sql("SELECT * FROM think_dk.shop_payments WHERE order_id = 772 AND id = 221")) {

	$sql = "UPDATE think_dk.shop_orders SET comment = 'Changer' WHERE id = 596";
	$query->sql($sql);
	$sql = "UPDATE think_dk.shop_order_items SET name = 'Changer', item_id = 366, unit_price = 100, unit_vat = 20, total_price = 100, total_vat = 20 WHERE id = 598";
	$query->sql($sql);


	$sql = "UPDATE think_dk.shop_order_items SET name = 'Changer, automatic renewal (15/02/2018 - 15/03/2018)', item_id = 366, unit_price = 100, unit_vat = 20, total_price = 100, total_vat = 20 WHERE id = 731";
	$query->sql($sql);


	$sql = "UPDATE think_dk.shop_orders SET comment = 'Membership renewed (15/03/2018 - 15/04/2018)' WHERE id = 772";
	$query->sql($sql);
	$sql = "UPDATE think_dk.shop_order_items SET name = 'Changer, automatic renewal (15/03/2018 - 15/04/2018)' WHERE id = 774";
	$query->sql($sql);
...
if($query->sql("SELECT * FROM think_dk.shop_payments WHERE order_id = 701 AND id = 233")) {

	print "SHIFTING SOFIE";


	// SWITCH STATUS' FOR 701 and 933
	$sql = "UPDATE think_dk.shop_orders SET status = 0, payment_status = 0, shipping_status = 0 WHERE id = 701";
	$query->sql($sql);
	$sql = "UPDATE think_dk.shop_orders SET status = 2, payment_status = 2, shipping_status = 2 WHERE id = 933";
	$query->sql($sql);



	// Make room for shifting
	$sql = "UPDATE think_dk.shop_order_items SET id = 7031 WHERE id = 703";
	$query->sql($sql);


	// 929 -> 701
	$sql = "UPDATE think_dk.shop_order_items SET id = 703, order_id = 701 WHERE id = 931";
	$query->sql($sql);

	// 930 -> 929
	$sql = "UPDATE think_dk.shop_order_items SET id = 931, order_id = 929 WHERE id = 932";
	$query->sql($sql);

	// 931 -> 930
	$sql = "UPDATE think_dk.shop_order_items SET id = 932, order_id = 930 WHERE id = 933";
	$query->sql($sql);

	// 932 -> 931
	$sql = "UPDATE think_dk.shop_order_items SET id = 933, order_id = 931 WHERE id = 934";
	$query->sql($sql);

	// 933 -> 932
	$sql = "UPDATE think_dk.shop_order_items SET id = 934, order_id = 932 WHERE id = 935";
	$query->sql($sql);
	
	// 701 -> 933
	$sql = "UPDATE think_dk.shop_order_items SET id = 935, order_id = 933 WHERE id = 7031";
	$query->sql($sql);
	$sql = "UPDATE think_dk.shop_payments SET order_id = 933 WHERE id = 233";
	$query->sql($sql);

	$sql = "UPDATE think_dk.shop_orders SET comment = 'Membership renewed (21/02/2018 - 21/03/2018)' WHERE id = 701";
	$query->sql($sql);

	$sql = "UPDATE think_dk.shop_orders SET comment = 'Membership renewed (21/03/2018 - 21/04/2018)' WHERE id = 929";
	$query->sql($sql);

	$sql = "UPDATE think_dk.shop_orders SET comment = 'Membership renewed (21/04/2018 - 21/05/2018)' WHERE id = 930";
	$query->sql($sql);

	$sql = "UPDATE think_dk.shop_orders SET comment = 'Membership renewed (21/05/2018 - 21/06/2018)' WHERE id = 931";
	$query->sql($sql);

	$sql = "UPDATE think_dk.shop_orders SET comment = 'Membership renewed (21/06/2018 - 21/07/2018)' WHERE id = 932";
	$query->sql($sql);

	$sql = "UPDATE think_dk.shop_orders SET comment = 'Changer Light (Downgrade)' WHERE id = 933";
	$query->sql($sql);
...
if($query->sql("SELECT * FROM think_dk.shop_payments WHERE order_id = 749 AND id = 237")) {

	print "SHIFTING BEATE";


	// SWITCH STATUS' FOR 749 and 940
	$sql = "UPDATE think_dk.shop_orders SET status = 0, payment_status = 0, shipping_status = 0 WHERE id = 749";
	$query->sql($sql);
	$sql = "UPDATE think_dk.shop_orders SET status = 2, payment_status = 2, shipping_status = 2 WHERE id = 940";
	$query->sql($sql);


	// Make room for shifting
	$sql = "UPDATE think_dk.shop_order_items SET id = 7511 WHERE id = 751";
	$query->sql($sql);


	// 934 -> 749
	$sql = "UPDATE think_dk.shop_order_items SET id = 751, order_id = 749 WHERE id = 936";
	$query->sql($sql);


	// 935 -> 934
	$sql = "UPDATE think_dk.shop_order_items SET id = 936, order_id = 934 WHERE id = 937";
	$query->sql($sql);

	// 936 -> 935
	$sql = "UPDATE think_dk.shop_order_items SET id = 937, order_id = 935 WHERE id = 938";
	$query->sql($sql);

	// 937 -> 936
	$sql = "UPDATE think_dk.shop_order_items SET id = 938, order_id = 936 WHERE id = 939";
	$query->sql($sql);

	// 938 -> 937
	$sql = "UPDATE think_dk.shop_order_items SET id = 939, order_id = 937 WHERE id = 940";
	$query->sql($sql);

	// 939 -> 938
	$sql = "UPDATE think_dk.shop_order_items SET id = 940, order_id = 938 WHERE id = 941";
	$query->sql($sql);

	// 940 -> 939
	$sql = "UPDATE think_dk.shop_order_items SET id = 941, order_id = 939 WHERE id = 942";
	$query->sql($sql);

	// 749 -> 940
	$sql = "UPDATE think_dk.shop_order_items SET id = 942, order_id = 940 WHERE id = 7511";
	$query->sql($sql);

	$sql = "UPDATE think_dk.shop_payments SET order_id = 940 WHERE id = 237";
	$query->sql($sql);


	$sql = "UPDATE think_dk.shop_orders SET comment = 'Membership renewed (23/02/2018 - 23/03/2018)' WHERE id = 749";
	$query->sql($sql);

	$sql = "UPDATE think_dk.shop_orders SET comment = 'Membership renewed (23/03/2018 - 23/04/2018)' WHERE id = 934";
	$query->sql($sql);

	$sql = "UPDATE think_dk.shop_orders SET comment = 'Membership renewed (23/04/2018 - 23/05/2018)' WHERE id = 935";
	$query->sql($sql);

	$sql = "UPDATE think_dk.shop_orders SET comment = 'Membership renewed (23/05/2018 - 23/06/2018)' WHERE id = 936";
	$query->sql($sql);

	$sql = "UPDATE think_dk.shop_orders SET comment = 'Membership renewed (23/06/2018 - 23/07/2018)' WHERE id = 937";
	$query->sql($sql);

	$sql = "UPDATE think_dk.shop_orders SET comment = 'Membership renewed (23/07/2018 - 23/08/2018)' WHERE id = 938";
	$query->sql($sql);

	$sql = "UPDATE think_dk.shop_orders SET comment = 'Membership renewed (23/08/2018 - 23/09/2018)' WHERE id = 939";
	$query->sql($sql);

	$sql = "UPDATE think_dk.shop_orders SET comment = 'Changer (Downgrade)' WHERE id = 940";
	$query->sql($sql);
