	...
	*/
	function __construct() {
		...
		$this->addToModel("backer_1", array(
			"type" => "user_id",
			"label" => "Backer 1",
			"hint_message" => "Select your 1st backer.",
			"error_message" => "You need to select a 1st backer."
		));
		// backer_2
		$this->addToModel("backer_2", array(
			"type" => "user_id",
			"label" => "Backer 2",
			"hint_message" => "Select your 2nd backer.",
			"error_message" => "You need to select a 2nd backer."
		));
