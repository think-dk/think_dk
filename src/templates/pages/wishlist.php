...
$page_item = $IC->getItem(array("tags" => "page:wishlist", "extend" => array("user" => true, "mediae" => true)));
if($page_item) {
...
<? if($page_item && $page_item["status"]): 
	...
	<div class="article i:article id:<?= $page_item["item_id"] ?>" itemscope itemtype="http://schema.org/Article">
		...
		<ul class="info">
			...
			<li class="main_entity" itemprop="mainEntityOfPage" content="<?= SITE_URL."/wishlist" ?>"></li>
